...
export function Button({
  ...
  const variants = {
    ...
    outline: [
      ...
      'shadow-sm',
      'hover:bg-muted/50 hover:border-primary/60 hover:text-foreground hover:shadow-md hover:-translate-y-0.5',
      ...
      'disabled:bg-muted/30 disabled:text-muted-foreground disabled:border-border/50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-sm',
    ].join(' '),
    ghost: [
